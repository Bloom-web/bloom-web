...
<?php include 'navigation.php';?>
        ...
        <main id="content">
            <header class="page-header center x-large image-background no-padding rel" style="background-image: url('images/background-home.jpg');">
                <div class="row">
                    <div class="header-blurb blurb-home xl regular col-md-7">
                        ...
                        <div class="flush">
                            <div class="row">
                                ...
                                <div class="col-md-5 iblock-mono padding-small">
                                    <div class="center">
                                        <div class="centered">
                                            <div class="header-text tleft xl white">
                                                <p class="">
            ...
            <section class="pt-medium pb-medium light-color grayback firstblock">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="xxxl thin">Aggregating data and apps</p>
                            <p class="lg regular">
            ...
            <section class="pt-medium pb-medium light-color">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="xxxl thin">Holographic computing</p>
                            <p class="lg regular">
            ...
            <section class="pt-medium pb-medium light-color grayback">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="xxxl thin">IoT big data is here</p>
                            <p class="lg regular">
