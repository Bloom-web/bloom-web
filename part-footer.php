                    ...
                    <div class="row">
                        <div class="pad-top-50 pad-bottom-20">
                            ...
                            <div class="medium">
                                ...
                                <div class="col-9-items col-xs-12 iblock-multi">
                                    ...
                                    <p><a href="/corporate/#board" class="text-0">Advisory board</a></p>
                        ...
                        <div class="text-right">
                            <ul class="social-icons medium circle social-hover">
                                ...
                                <li class="pad-left-20"><a href="<?php perch_content('facebook');?>" target="_blank" class="facebook" title="facebook"><i class="icon-glyph-320"></i></a></li>
