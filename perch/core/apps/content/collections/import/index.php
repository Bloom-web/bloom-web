<?php
    ...
    $Perch->page_title = PerchLang::get('Import');
    ...
    include(PERCH_CORE.'/runway/apps/content/modes/collection.import.pre.php');
    
    include(PERCH_CORE . '/inc/top.php');

    include(PERCH_CORE.'/runway/apps/content/modes/collection.import.post.php');
