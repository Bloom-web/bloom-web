<?php
    ...
    $Perch->page_title = PerchLang::get('Reorder Collection');
    ...
    include(PERCH_CORE.'/runway/apps/content/modes/collection.reorder.pre.php');
    
    include(PERCH_CORE . '/inc/top.php');

    include(PERCH_CORE.'/runway/apps/content/modes/collection.reorder.post.php');
