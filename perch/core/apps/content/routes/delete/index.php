<?php
    ...
    $Perch->page_title = PerchLang::get('Delete Page Route');
    ...
    include(PERCH_CORE.'/runway/apps/content/modes/routes.delete.pre.php');
    
    include(PERCH_CORE . '/inc/top.php');

    include(PERCH_CORE.'/runway/apps/content/modes/routes.delete.post.php');
