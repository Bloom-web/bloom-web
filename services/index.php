                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <p class="text0000 light">Strategic consulting</p>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <p class="text0000 light">IoT and big data analytics</p>
                                <p class="text0 regular">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <p class="text0000 light">Holographic computing experiences</p>
                                <p class="text0 regular">
                                    As part of the Microsoft Windows Insiders Program and a leading Windows 10 application development partner, Bloom will soon be innovating for business with the HoloLens development Kit. In late Q2, Bloom will be announcing new solutions to collaborate virtually.
                                </p>
                            </div>
                        </div>
                    </div> <!-- / row -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <p class="text0000 light">Azure cloud services</p>
                                <p class="text0 regular">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <p class="text0000 light">Project management outsourcing</p>
                                <p class="text0 regular">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <p class="text0000 light">Project management transformation</p>
                                <p class="text0 regular">
