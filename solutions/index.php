...
<?php include($_SERVER["DOCUMENT_ROOT"] . "/navigation.php");?>
        ...
        <main id="content">
            ...
            <section class="pt-medium light-color">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-md-push-5"><a name="sales" class="anchor"></a>
                        ...
                        <div class="col-md-5 col-md-pull-7 pad-top-75 text-center">
            ...
            <section class="pt-medium pb-medium light-color">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7"><a name="marketing" class="anchor"></a>
